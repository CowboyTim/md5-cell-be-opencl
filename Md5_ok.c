...
void MD5Calc (unsigned char *inBuf, UINT4 inLen)
{
  ...
  //in[14] = (UINT4) inLen << 3;
  //in[15] = (UINT4) inLen >> 29;

  //memcpy (&scratch_in, inBuf, mdi);
  //scratch_in[mdi] = 0x80;
  /*for (i = mdi + 1, ii = 0; i < 56; i++, ii++)
	{
	  scratch_in[i] = 0x00;
	}*/
 ...
 */
static void Transform (UINT4 * in)
{
